...
<body>
    <header>
        <h2 class="text-center">Registrar Productos</h2>
    </header>
    <section>
        <?php
            error_reporting(0);
    ...
    <br><button type="button" onclick="location.href='http://localhost/Jewy_access/secciones/vista_productos.php'">Atras</button>
</body>
</html>